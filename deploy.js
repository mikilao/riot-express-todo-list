...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    "/home/ubuntu/riot-express-todo-list-master-temp",
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    "rm -rf riot-express-todo-list-temp && mkdir riot-express-todo-list-master-temp",
    {
      cwd: "/home/ubuntu",
    }
  );
...
function updateRemoteApp() {
  return ssh.execCommand(
    "mkdir riot-express-todo-list-master && cp -r riot-express-todo-list-master-temp/* riot-express-todo-list-master/ && rm -rf riot-express-todo-list-temp",
    {
      cwd: "/home/ubuntu",
    }
  );
...
function restartRemoteServices() {
  return ssh.execCommand(
    "cd riot-express-todo-list-master && sudo service mongod start && pm2 start app.js",
    {
      cwd: "/home/ubuntu",
    }
  );
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function () {
      console.log("Creating `riot-express-todo-list-master-temp` folder.");
